...
public class ReflectionBenchmark {
    ...
    public void setup() throws Throwable {
        ...
        methodHandle = lookup.findVirtual(Student.class, methodName, mt);

        // Lambda metafactory
        lambda = (StudentInterface) LambdaMetafactory.metafactory(
            lookup,
            methodName,
            MethodType.methodType(StudentInterface.class),
    ...
    public void lambdaMetafactory(Blackhole bh) throws Throwable {
        String name = lambda.name(student);
        bh.consume(name);
    }
